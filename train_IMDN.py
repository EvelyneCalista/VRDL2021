...
parser.add_argument("--cuda", action="store_true", default=True,
                    help="use cuda")
parser.add_argument("--resume", default="/media/bsplab/Disk/Evelyne_Class/Sem1/CV_DL/HW4/IMDN-master/checkpoint_x2/epoch_273.pth", type=str,
...
testset = Set5_val.DatasetFromFolderVal("/media/bsplab/Disk/Evelyne_Class/Sem1/CV_DL/HW4/data_IMDN/testing_data/test_HR",
                                       "/media/bsplab/Disk/Evelyne_Class/Sem1/CV_DL/HW4/data_IMDN/testing_data/test_LR/X{}/".format(args.scale),
                                       args.scale)
...
def save_checkpoint(epoch):
    model_folder = "checkpoint_prex2_x{}/".format(args.scale)
